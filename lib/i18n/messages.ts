...
export const messages = {
  en: {
    ...
    gallery: {
      ...
      title: "Gallery",
      loadMore: "Load more",
      allShown: "All {count} photos shown",
      empty: "Photos for this celebration will appear here soon.",
      emptyReels: "Videos will appear here soon.",
      close: "Close",
      videoPlaceholder: "Video coming soon",
      reelsCount: "{count} videos across all events",
      stats: {
        photos: "Photos",
        videos: "Videos",
        events: "Events",
  ...
  ne: {
    ...
    gallery: {
      label: "हाम्रो विवाह ग्यालरी",
      title: "ग्यालरी",
      loadMore: "थप हेर्नुहोस्",
      allShown: "सबै {count} फोटो देखाइयो",
      empty: "यो उत्सवका फोटोहरू चाँडै यहाँ आउनेछन्।",
      emptyReels: "भिडियोहरू चाँडै यहाँ आउनेछन्।",
      close: "बन्द गर्नुहोस्",
      videoPlaceholder: "भिडियो चाँडै आउँदैछ",
      reelsCount: "सबै कार्यक्रममा {count} भिडियो",
      stats: {
        photos: "फोटो",
        videos: "भिडियो",
        events: "कार्यक्रम",
      ...
      tabs: {
        all: "सबै",
        mehendi: "मेहेन्दी",
        weddingDay: "विवाह दिवस",
        ganeshSagun: "सगुन र गणेश",
        reception: "रिसेप्शन",
        reels: "रिल र भिडियो",
      },
    },
