      ...
      <div className="relative z-10 min-h-screen">
        ...
        <div className="absolute inset-x-0 bottom-[10%] flex flex-col items-center px-6 md:bottom-[12%]">
          ...
          <div className="mt-12 flex w-full flex-col items-center md:mt-16">
            <a
              href="#details"
              className="glass flex flex-col items-center gap-2 rounded-2xl px-4 py-2 text-xs font-bold uppercase tracking-[0.25em] text-black transition-colors hover:bg-white/60 hover:text-wedding"
            >
